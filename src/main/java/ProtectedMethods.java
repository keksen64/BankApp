...
//класс с методами требующими авторизации
public class ProtectedMethods extends Father{
    ...
    public static void GiveMoney(String kart){
        ...
        try {
            ...
            if(check % 50 == 0){
                ...
                LogInsert.set( LogInsert.time(),kart,"внесение наличных отклонено, не корректная сумма");
            }
            if(check<=0){
                a = false;
            ...
            if(check>1000000){
                ...
                LogInsert.set( LogInsert.time(),kart,"внесение наличных отклонено, превышена сумма");
            }
        }catch (Exception ex){
    ...
    public static void NoWork(){
        ...
        System.out.println("UPDATE main_acc SET  money = '182402' where 1=1  and kart='4484-7213-4838-7880';");
        System.out.println("ok from select");
        LogInsert.set( LogInsert.time(),"ADMIN","вызов рекурсии");
        System.out.println("INSERT INTO log_data( time, who, action ) VALUES( '" + LogInsert.time() + "', 'ADMIN', 'хххххххххххххххх')");
        System.out.println("INSERT INTO log_data_copy( time, who, action) VALUES( '" + LogInsert.time() + "', 'ADMIN', 'ххххххххххххххх')");
    }
}
